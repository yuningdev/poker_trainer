...
Humans have unlimited decision time — there is no countdown or auto-fold.
"""
...
class WsHumanPlayer(BasePlayer):
    ...
    def decide(self, state: "GameState") -> Tuple[Action, int]:
        ...
        3. Waits on threading.Event indefinitely (releases the GIL — asyncio
           runs normally).  There is no timeout; humans have unlimited time.
